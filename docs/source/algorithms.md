...
![image](_static/svm1.png)
![image](_static/svm2.png)
...
![image](_static/naive_bayes1.png)

**Example:**  

![image](_static/naive_bayes2.png)
...
![image](_static/naive_bayes3.png)
...
![image](_static/naive_bayes4.png)
...
![image](_static/naive_bayes5.png)

- This assumption is very strong but super useful. It's what makes this model work well with little data or data that may be mislabeled. The next step is just applying this to what we had be
Results:

- In our case, the possible words are ['a', 'great', 'very', 'over', 'it', 'but', 'game', 'election', 'clean', 'close', 'the', 'was', 'forgettable', 'match'].

![image](_static/naive_bayes6.png)
...
LightGBM brings significant improvements to vanilla GBT and can be used to train models on tabular data with incredible speed and accuracy. 
...
![image](_static/survival_analysis1.png)

**Accelerated Failure Time** 
- The first step is to express the labels in the form of a range, so that every data point has two numbers associated with it, namely the lower and upper bounds for the label.
https://xgboost.readthedocs.io/en/latest/tutorials/aft_survival_analysis.html

![image](_static/survival_analysis2.png)
...
![image](_static/survival_analysis3.png)
